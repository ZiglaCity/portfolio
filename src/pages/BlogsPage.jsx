...
export default function BlogsPage({setSearchWord, searchBlog, blogs, selectedPost, setSelectedPost, searhedBlogs, setSearchBlog, sortBlogs}){
  return (
